...
// import { useLanguage } from '../context/LanguageContext'; // ⬅️ context
// import '../App.css';
...
//     switchLang(code);
//     closeOffcanvas(); // close menu after switching
//   };
...
//           <span className="fw-semibold text-warning">اهلا وسهلا</span>
//         </a>
...
//                 <button
//                   className={`btn btn-sm ${lang === 'ar' ? 'btn-warning' : 'btn-outline-secondary'}`}
//                   onClick={() => handleLangChange('ar')}
//                 >
//                   AR
//                 </button>
//                 <button
//                   className={`btn btn-sm ${lang === 'he' ? 'btn-warning' : 'btn-outline-secondary'}`}
//                   onClick={() => handleLangChange('he')}
//                 >
//                   HE
//                 </button>
//                 <button
//                   className={`btn btn-sm ${lang === 'en' ? 'btn-warning' : 'btn-outline-secondary'}`}
